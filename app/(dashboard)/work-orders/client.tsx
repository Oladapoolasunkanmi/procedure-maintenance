            ...
            {selectedWorkOrder ? (
                ...
                <div className="hidden flex-1 items-center justify-center rounded-lg border border-dashed md:flex">
                    <div className="flex flex-col items-center gap-2 text-center text-muted-foreground">
                        ...
                        <h3 className="text-lg font-semibold">No Work Order Selected</h3>
                        <p className="text-sm">Select a work order from the list to view details.</p>
                    </div>
                </div>
            )}
        </div>
        ...
        <div className="flex h-full flex-col">
            <div className="flex items-center justify-between border-b p-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <ChatInterface open={showChat} onOpenChange={setShowChat} title={`Comments: ${workOrder.title}`} />
                    <DropdownMenu>
            ...
            <ScrollArea className="flex-1">
                <div className="flex flex-col gap-6 p-6">
                    ...
                    <div className="grid grid-cols-4 gap-2">
                        <StatusActionButton status="Open" current={workOrder.status} icon={Lock} label="Open" color="bg-muted text-foreground" />
                        <StatusActionButton status="On Hold" current={workOrder.status} icon={PauseCircle} label="On Hold" color="bg-orange-500" />
                        <StatusActionButton status="In Progress" current={workOrder.status} icon={PlayCircle} label="In Progress" color="bg-blue-500" />
                        <StatusActionButton status="Done" current={workOrder.status} icon={CheckCircle2} label="Done" color="bg-green-600" />
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div className="flex flex-col gap-1">
                            <span className="text-xs font-medium text-muted-foreground">Work Order ID</span>
