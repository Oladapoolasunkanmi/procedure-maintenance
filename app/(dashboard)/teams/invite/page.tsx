...
export default function InviteUsersPage() {
    ...
    const handleSendInvites = async () => {
        ...
        toast({
            title: "Invites Sent",
            description: `Successfully sent ${invites.length} invite(s).`,
        })
                ...
                <CardContent className="p-8 space-y-6">
                    <div className="space-y-4">
                        <div className="grid grid-cols-12 gap-4 text-sm font-medium text-muted-foreground px-1">
                            ...
                            <div className="col-span-5">Mobile Phone Number or Email</div>
                            ...
                            <div key={row.id} className="grid grid-cols-12 gap-4 items-start">
                                ...
                                <div className="col-span-3 flex items-center gap-2">
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            <SelectItem value="full">Full User</SelectItem>
